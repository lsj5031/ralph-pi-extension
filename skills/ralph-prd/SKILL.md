---
name: ralph-prd
description: "Convert PRDs to Ralph's prd.json format for autonomous execution. Use when you have a PRD (markdown or text) and want to convert it to Ralph's JSON format. Triggers on: convert to ralph format, create prd.json from this, ralph json format, convert prd to json."
---

# Ralph PRD Converter

Converts existing PRDs to the prd.json format that Ralph uses for autonomous execution with pi.
...
5. Track progress in progress.txt
